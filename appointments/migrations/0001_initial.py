# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-09-07 12:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_time', models.TimeField(help_text='The time the appointment is scheduled to start. If not supplied, this is automatically set to the current time', verbose_name='Appointment start time')),
                ('end_time', models.TimeField(help_text='The time the appointment is scheduled to end. If not supplied, this is automatically set to an hour after start time', verbose_name='Appointment end time')),
